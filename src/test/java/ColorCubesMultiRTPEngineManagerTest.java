...
public class ColorCubesMultiRTPEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(ColorCubesMultiRTPEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/ColorCubesMultiRTP/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/ColorCubesMultiRTP/InitOutcome.xml").getDocumentElement();
