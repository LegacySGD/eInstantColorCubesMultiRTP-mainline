...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:x="anything">
	...
	<xsl:variable name="prizeNamesString">
		<xsl:value-of select="//GHSTCollectionMappings/PrizeNames/@prizes" />
	</xsl:variable>

	<xsl:variable name="pricePointsString">
		<xsl:value-of select="//GHSTCollectionMappings/PricePoints/@pricePoints" />
	</xsl:variable>

	<xsl:variable name="prizeTableString">
		<xsl:value-of select="//GHSTCollectionMappings/PrizeTables/@prizeValues" />
	</xsl:variable>

	<xsl:variable name="collectionCounts">
		<xsl:value-of select="//GHSTCollectionMappings/CollectionCounts/@collections" />
	</xsl:variable>

	<xsl:variable name="cubeBoardSize">
		<xsl:value-of select="//GHSTCollectionMappings/CubeBoard/@width" />
		<xsl:text>,</xsl:text>
		<xsl:value-of select="//GHSTCollectionMappings/CubeBoard/@height" />
	</xsl:variable>
	<xsl:template match="/Paytable">
		<x:stylesheet version="1.0" xmlns:java="http://xml.apache.org/xslt/java" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
			...
			<x:template name="Scenario.Detail">
				...
				<x:variable name="collections">
					<xsl:value-of select="$collectionCounts" />
				</x:variable>

				<x:variable name="boardDimensions">
					<xsl:value-of select="$cubeBoardSize" />
				</x:variable>
				...
				<x:value-of select="my-ext:formatJson($odeResponseJson, $prizeNames, string($convertedPrizeValues), $collections, $boardDimensions, $translations)"
